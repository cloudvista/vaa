...
1. __Screen Metrics__: Simple/filtered analysis of types and volumes of use of all VistA Applications for a given VistA. This provides *screen metrics* to be used in the VistA application-specific analysis.
...
3. ___Workflow Analysis__: The Vista Documentation Library (VDL) contains the contains User Guides for VistA Applications, which describe the *documented workflow* of specific VistA Applications. The documentation and screenshots of specific VistA Applications be parsed and classified in a standardized form to permit analysis.
4. __Workflow Correlation Analysis__ - Correlate the (1) Actual screens generated by live users of a VistA Applicaiton (2) Documented screens based on VistA Documentation Library descriptions for specific VistA Applications (3) Actual workflow - based on longest common sequence (LCS) analyss of known RPCs an their fuction.
