...
* The captures and analyzes VA's clinmical workflows to improve use of VA's care applications - improving clinical efficiency, expanding access to care, and reducing costs.
* VAA workflow capture also enables VA's current workflows to  be migrated to new clients and systems -  without a loss of clinical efficiency.
