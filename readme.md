...
A. __Metrics Analysis (Statistical Analysis)__:  
Raw unprocessed RPC traffic is quality controlled for completeness and correctness.  
RPCs are identified by type, use, and client for all traffic and all clients.
