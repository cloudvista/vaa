...
1. __Screen Metrics__ - simple/filtered analysis of types and volumes of use of all Vista clients
2. __Actual Workflows__ - identify and classify the longest common sequences (LCS) of RPCs generated by VistA Applications. This correlates to the *actual workflow* of end-users of a VistA Application.
4. __Documented Workflows__ - The Vista Documentation Library (VDL) contains the contains User Guides for VistA Applications, which correspondes to the documented workflow of a given VistA Application. This documentation and screenshots will be parsed and classified in a standardized form to permit analysis.
5. __Workflow Correlation Analysis__ - Correlate the (1) Actual screens generated by live users of a VistA Applicaiton (2) Documented screens based on the VistA application user guides in the VistA Documenation Library (VDL)  (3) Actual workflow - based on LCS analyss of known RPC an their fuction.
