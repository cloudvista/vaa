...
1. __Filtered Analysis__ (screen metrics): Simple/filtered analysis of types and volumes of use of all clients of a given VistA.
2. __Sequence Analysis__ (actual workflow / screens): Identify and classify the longest common sequences (LCS) of RPCs generated by VistA Applications. This correlates to the *actual workflow* of end-users of a VistA Application.
3. ___Workflow Analysis__ (documented workflow / screens): The Vista Documentation Library (VDL) contains the contains User Guides for VistA Applications, which describe the documented workflow of a given VistA Application. This documentation and screenshots will be parsed and classified in a standardized form to permit analysis.
