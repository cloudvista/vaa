...
2. Longest Common Sequence (LCS) analysis - identify and classify the longest common sequences of RPCs generated by VistA Applications, which correlates to the *actual workflow*.
...
5. Workflow Correlation Analysis - Correlate the (1) actual screens based on live end-user screenshots (2) documented screens based on the VistA application user guides in the VistA Documenation Library (VDL)  (3) 
