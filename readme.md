...
2. Sequence Analysis - identify and classify the longest common sequences (LCS) of RPCs generated by VistA Applications. This correlates to the *actual workflow*.
