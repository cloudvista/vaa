...
### Introduction
Each day in VA clinical staff use a suite of VistA applications (CPRS, Imaging, and 40+ others) to create and process over 50 million documents, orders, labs, images, and transactions for veteran care.  In an average work week, VA staff use CPRS - the main VistA application - more than 4.4 million hours. The use of the CPRS Vista application is more than any other application in VA - even more than all Microsoft Office applications combined.
