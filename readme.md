...
### Summary
VAA is a first-ever comprehensive capture and analysis VA's actual clinical workflows. VAA is based on the capture of all traffic generated by all users and usage of all point-of-care applications  in operation at VA medical centers. All workflow is identifiable by user, specialty, facility. Down to the millisecond.

The most important point-of-care application in VA is CPRS.  Each day CPRS processes over 50 million new documents, orders, labs, alerts, and transactions for veteran care. In an average week, VA staff use CPRS more than 2.2 million hours to care for veterans. Each year CPRS supports more than 115 million veteran care encounters. 
...
Saving just one minute per veteran care encounter would save 115 million minutes across the VA - adding 2 million more hours of care access to veterans.

This traffic-based approach to capturing workflow is an empirical-data driven. It is not notional or speculative. It is not based on a human observer with a stopwatch.
VAA comprehensively captures 35 years of institutional knowledge, mandates, and veteran-specific care which is contained in the CPRS workflow.
