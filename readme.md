...
### Summary
VistA Application Analysis (VAA) is a first-ever comprehensive capture and analysis VA's point-of-care clinical workflows. VAA is based on the capture of all traffic generated by all users and usage of all VistA point-of-care applications currently in operation at VA medical centers. All workflows are identifiable by specific user, specialty, facility - all the way to each individual mouse click.
