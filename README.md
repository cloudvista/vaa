...
Provides comprehensive capture and analytics of the workflows and interaction dynamitcs ("click flows") of clinical staff using VistA's point-of-care applications (CPRS and others).  Enables enterprise standardization and optimization of clinical workflows across VAMCs and VISNs improving clinical efficiency and enabling the transition to a single integrated enterprise EHR.
